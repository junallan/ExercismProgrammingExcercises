...
public static class TestTrack
{
    ...
    {
        var productionRemoteControlCars = new List<ProductionRemoteControlCar>{prc1, prc2}; //prc1.CompareTo(prc2) < 0 ? new List<ProductionRemoteControlCar> { prc1, prc2 } : new List<ProductionRemoteControlCar> { prc2, prc1 };
